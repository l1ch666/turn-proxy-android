...
internal object ProfileJson {
    ...
    private fun encode(p: Profile): JSONObject = JSONObject().apply {
        ...
        put("client", JSONObject().apply {
            ...
            put("tunnelMode", p.client.tunnelMode.name)
            put("fullTunnelClientUri", p.client.fullTunnelClientUri)
        })
    ...
    private fun decode(o: JSONObject): Profile {
        ...
        return Profile(
            ...
            client = ClientConfig(
                ...
                tunnelMode = TunnelMode.fromStorage(cliO.optString("tunnelMode", "")),
                fullTunnelClientUri = cliO.optString("fullTunnelClientUri")
            ),
